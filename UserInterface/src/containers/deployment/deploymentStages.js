    ...
    render() {
        ...
        if (currDeployment.stage_info) {
            ...
            deployStage = Object.keys(currDeployment.stage_info).map((value, index) => {
                ...
                return (
                    <a className={(currDeployment.stage_info[value].status ? (currDeployment.stage_info[value].status == 'Completed' ? "completed" : "failed") : "inprog")}>
                        <span>{value}</span>
            ...
            <>
                <div className="devnet-deploy-info open">
                    <div className="devnet-deploy-head">
                        ...
                        <div className="devnet-deploy-time">Deployed: <span>{depDate[0]} | {timeTaken} (mm:ss)</span></div>
