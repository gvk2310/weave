...
class Test extends React.Component{
        ...
        if(this.state.listening) {
            ...
            eventSource.addEventListener("tests", event => {
                ...
                if(usage.test_id){
                    ...
                    let remtest = testArrCopy.filter(task => {
    ...
    handleEditTest = (id,name,testScript,index) => {
        this.setState({
            testId:id,
            testName:name,
            testScriptType:testScript,
            edit:true,
        });
    ...
    render(){
      console.log("test inside render",this.state.test)
        ...
        if(this.state.test.length > 0) {
            test = this.state.test.map((value,index) => {            
                return <tr className="" key={index} >
                    ...
                    <td align="center"><div className={(value.scan_result == 'Safe' ? "dev-net-status done" : "dev-net-status fail")}>&nbsp;</div></td>
                    <td>{value.onboard_status}</td>
                    <td class="text-center">
                        <div class="dev-actions">
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#myUpdateRepositoryModal" onClick={() => this.handleEditTest(value.test_id,value.test_name,value.test_scripttype,index)}><img src={require("images/edit.svg")} alt="Edit"/></a>
        ...
        let addTestModal = <form className="modalbody" id='addTestForm' onSubmit= {this.handleAddTest.bind(this)}> 
            <div class="row">
        ...
        let updateTestModal = <form className="modalbody" id='updateTestForm' onSubmit= {this.handleAddTest.bind(this)}> 
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label class="form-label">Test Name</label>
                        <input value={this.state.testName} type="text" class="form-control" placeholder="Enter Name"/>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="test_scripttype" class="form-control" disabled>
                            <option selected>{this.state.testScriptType}</option>
                        </select>
                    </div>
                </div>
            </div>
