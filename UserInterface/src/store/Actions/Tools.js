import { CORETOOLSDETAILS, NONCORETOOLSDETAILS, CUSTOMTOOLDETAILS, CARTRIDGES, TOOLS_ORDER_ID, CARTRIDGE_ORDER_ID ,PIPELINENAMES } from '../Types/ActionTypes';
...
export const setPipelineData = (pipelinenames) => {
    return {
        type: PIPELINENAMES,
            pipelinenames
    }
